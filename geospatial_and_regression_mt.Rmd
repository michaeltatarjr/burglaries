...
There appears to be the following:
   intplat=latitude
   intptlon=longitude
Q's that I may loo into as part of EDA... 
...
#note that some suggest to drop the geometry, using   st_drop_geometry() |>   not included here.  
...
Or, for every dollar increase in median income, burglaries are expected to decrease by 0.00002326 in the log of expected counts.
  #Note that the results are a little different, even though they should be the same...
```{r}
